        ...
        <div className="relative bg-[linear-gradient(135deg,#5B21B6_0%,#7C3AED_50%,#6D28D9_100%)]">
            <nav className="flex justify-between items-center py-4 px-6 border-b-2 border-b-gray-400">
                ...
                <div className="flex gap-3">
                    <Button onClick={handleLogin} variant="outline" className="h-9 bg-transparent text-white border-white hover:bg-white hover:text-blue-600 cursor-pointer">
                        Login
                    </Button>
                    <Button onClick={handleSignup} className="h-9 bg-amber-500 hover:bg-amber-600 text-white cursor-pointer">
                        Sign up
                    </Button>
                </div>
            </nav>
